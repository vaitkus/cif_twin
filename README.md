[![CIF syntax check](https://github.com/COMCIFS/Twinning_Dictionary/actions/workflows/main.yml/badge.svg)](https://github.com/COMCIFS/Twinning_Dictionary/actions)

# Twinning dictionary (twinCIF)

CIF data item definitions for twinning.

## Warning

[This dictionary](cif_twin.dic) is the latest **draft** version.
Definitions are subject to change and software should be careful not to hard-code information.
The latest approved twinning dictionary is available from the [IUCr CIF website](https://www.iucr.org/resources/cif/dictionaries).

## Contributing

Contributions are very welcome, both from twinning experts and people with technical CIF knowledge.
...
If the "Github way" is not familiar to you, we suggest looking at [some closed issues](https://github.com/COMCIFS/Twinning_Dictionary/issues?q=is%3Aissue+is%3Aclosed) and [some closed pull requests](https://github.com/COMCIFS/Twinning_Dictionary/issues?q=is%3Apr+is%3Aclosed) to see how the process works.
